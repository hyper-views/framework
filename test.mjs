...
test('view.mjs - producing virtual dom', (t) => {
  ...
  t.deepEquals(div`<div class=${'a'}>${1}</div>`, {tree: {id: null, tag: 'div', attributes: [{key: 'class', variable: true, value: 0}], children: [{variable: true, value: 1}]}, variables: ['a', 1]})

  t.deepEquals(div`<div class=${'b'}>${2}</div>`, {tree: {id: null, tag: 'div', attributes: [{key: 'class', variable: true, value: 0}], children: [{variable: true, value: 1}]}, variables: ['b', 2]})

  t.deepEquals(div`<div class=${'c'}>${3}</div>`, {tree: {id: null, tag: 'div', attributes: [{key: 'class', variable: true, value: 0}], children: [{variable: true, value: 1}]}, variables: ['c', 3]})
})
